...
namespace App\Filament\Resources\KaryaMahasiswas;

use App\Filament\Resources\KaryaMahasiswas\Pages\ManageKaryaMahasiswas;
...
class KaryaMahasiswaResource extends Resource
{
    ...
    {
        return [
            'index' => ManageKaryaMahasiswas::route('/'),
        ];
    }
}
