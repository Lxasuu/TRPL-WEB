...
@section('title', 'Service Details - TRPL Politeknik Meta Industri')
            ...
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <p class="mb-0">Detail layanan dan program unggulan kami.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="help-box d-flex flex-column justify-content-center align-items-center">
                        ...
                        <p class="d-flex align-items-center mt-2 mb-0"><i class="bi bi-telephone me-2"></i> <span>+62 21 8983 0001</span></p>
                        <p class="d-flex align-items-center mt-1 mb-0"><i class="bi bi-envelope me-2"></i> <a
                                href="mailto:trpl@politeknikmeta.ac.id">trpl@politeknikmeta.ac.id</a></p>
                    </div>
                ...
                <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>
                        Blanditiis voluptate odit ex error ea sed officiis desert. Cupiditate non consequatur et doloremque
